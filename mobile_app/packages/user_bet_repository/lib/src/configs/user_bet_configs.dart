...
abstract class UserBetConfigs {
  ...
  static const String getUserBetsCount =
      '${BaseConfigs.baseUrl}/get-user-bets-count';
  static const String getUserTotalWinsCount =
      '${BaseConfigs.baseUrl}/get-user-total-wins';
